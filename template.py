...
def format_comparison_table(results: list[dict]) -> str:
    ...
    rows = [
        [
            ...
            shorten(result.get("gpt4o_response", result.get("gpt-4o_response"))),
            shorten(result.get("mini_response")),
            shorten(result.get("gpt4o_latency", result.get("gpt-4o_latency"))),
            shorten(result.get("mini_latency")),
        ]
